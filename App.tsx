      ...
      <main>
        ...
        <section className="py-24 bg-slate-950 overflow-hidden">
          <div className="container mx-auto px-4 text-center mb-16">
            <h2 className="text-4xl md:text-5xl font-black uppercase mb-4 tracking-tighter italic">
              Werkstatt<span className="text-yellow-500">Report</span>
            </h2>
            <div className="w-20 h-1 bg-yellow-500 mx-auto mb-6"></div>
            <p className="text-slate-400 max-w-xl mx-auto font-medium">
              Hier wird geschweißt, geschraubt und vor allem getestet. Unser
              BierBus nimmt Form an.
            </p>
          </div>
          <div className="flex gap-6 overflow-x-auto pb-12 snap-x px-4 no-scrollbar">
            {[
              ...
              <div
                key={i}
                className="flex-shrink-0 w-80 md:w-96 aspect-video bg-slate-900 rounded-none overflow-hidden relative snap-center border border-white/10 group"
              >
                <img
                  src={src}
                  alt={`Bauphase ${i + 1}`}
